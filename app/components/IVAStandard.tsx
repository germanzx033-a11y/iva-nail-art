...
export default function IVAStandard({ language, onBook }: IVAStandardProps) {
  ...
  return (
    <section id="iva-standard" className="py-16 md:py-24 px-6 md:px-8 bg-white relative overflow-hidden">
      {/* Decorative Elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-[#B76E79]/5 to-transparent rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-[#8C6239]/5 to-transparent rounded-full blur-3xl" />

      <div className="relative max-w-6xl mx-auto">
        {/* Header */}
        <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#722F37]/10 to-[#B76E79]/10 rounded-full mb-4">
          ...
          <p className="text-lg text-[#3D3D3D] leading-relaxed mb-2">
            {content.subtitle}
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          {content.features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group bg-gradient-to-br from-[#FAF9F7] to-white rounded-2xl p-6 md:p-8 border border-[#EDE9E3] hover:border-[#B76E79]/30 hover:shadow-xl transition-all duration-300"
              >
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#B76E79]/20 to-[#722F37]/20 flex items-center justify-center flex-shrink-0 group-hover:from-[#B76E79] group-hover:to-[#722F37] transition-all duration-300">
                    <Icon className="w-6 h-6 text-[#722F37] group-hover:text-white transition-colors" />
                  </div>
        ...
        <div className="bg-gradient-to-br from-[#722F37] via-[#5A252C] to-[#3D1A1E] rounded-2xl p-8 md:p-12 text-white relative overflow-hidden">
          ...
          <div className="relative grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-white/90 text-lg leading-relaxed mb-6 border-l-4 border-[#B76E79] pl-4">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <p className="text-xs uppercase tracking-[0.2em] text-[#D4A5A5] mb-4">
              ...
              <div className="mt-6 pt-4 border-t border-white/20">
                <p className="text-[#D4A5A5] font-medium italic">
          ...
          <div className="relative mt-8 text-center">
            <p className="text-white/70 mb-4">{content.cta}</p>
            {onBook && (
              <button
                onClick={onBook}
